...
#warning namespace не соотвутствует действительности
namespace BookShopSystem
{
    #warning классы обычно разделяются каждый в свой файл
    public class Book
    {
        ...
        [JsonProperty("dateOfDelivery")] public DateTime ReceiptDate { get; set; }

        [JsonProperty("price")] public double Cost { get; set; }
    ...
    #warning у тебя проект почему-то типа Console application, хотя достаточно сделать Class library
    class Program
    {
